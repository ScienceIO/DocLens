...
if __name__ == "__main__":
    ...
    if eval_model == 'GPT':
        if dataset_name == 'meqsum':
            ...
            score_file_claim_recall = result_file.replace('.json', '.claim_min1max90.claim_scores')
            score_file_claim_precision = result_file.replace('.json', '.output_claim_min1max90.output_claim_scores')
